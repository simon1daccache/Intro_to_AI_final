...
def main_screen():
    ...
    while True:
        ...
        graphics_board.write_on_board("CHOOSE ONE OF THE OPTIONS TO PLAY", graphics_board.WHITE , 350 , 175, 30, True)
...
def bot_vs_human_screen():
    ...
    while True:
        graphics_board.write_on_board("CONNECT 4 GAME", graphics_board.RED , 350 , 100, 60, True)
        graphics_board.write_on_board("CHOOSE THE BOT TO PLAY AGAINST", graphics_board.WHITE , 350 , 175, 30, True)
